...
if __name__ == "__main__":
    ...
    # API 2개 사용할 때
    GoldMatchId = pd.read_csv('MatchId/GoldMatchId_I.csv')
    # saveWinDataset.saveDataSetToCSV(GoldMatchId, 'Dataset/win/Gold_I.csv', 15)

    # 데이터 수집 중단되면 중단된 matchId의 인덱스 번호 넣고 이어서 수집
    stopIndex = 388
    GoldMatchId = GoldMatchId.iloc[:, stopIndex:]
    saveWinDataset.append_saveDataSetToCSV(GoldMatchId, 'Dataset/win/Gold_I.csv', 15, stopIndex)
