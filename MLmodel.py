...
cb = CatBoostClassifier(iterations=2, depth=2, learning_rate=1)
...
xtree_pre = xtree.predict(test_x)

print("RandomForest :", round(accuracy_score(test_y, rf_pre)*100, 2), "%")
print("lightGBM :", round(accuracy_score(test_y, lgbm_pre)*100, 2), "%")
print("CatBoost :", round(accuracy_score(test_y, cb_pre)*100, 2), "%")
print("ExtraTrees :", round(accuracy_score(test_y, xtree_pre)*100, 2), "%")